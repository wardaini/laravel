...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-200">Edit Jabatan</h1>
    </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl shadow-lg">
        <form action="{{ route('jabatan.update', $jabatan->id_jabatan) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_jabatan" id="nama_jabatan" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:ring-indigo-500" value="{{ $jabatan->nama_jabatan }}" required>
            </div>
            <div class="mb-6">
                <label for="deskripsi" class="block text-sm font-medium text-gray-400 mb-1">Deskripsi</label>
                <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-200 focus:ring-indigo-500">{{ $jabatan->deskripsi }}</textarea>
            </div>
